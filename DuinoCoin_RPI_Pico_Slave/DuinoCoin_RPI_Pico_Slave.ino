...
#if defined(ARDUINO_AVR_UNO) | defined(ARDUINO_AVR_PRO) | defined(ARDUINO_ARCH_MBED_RP2040)
...
// RPi Pico - Arduino Mbed OS RP2040 Boards version 2.3.1
// I2C1 SCL - GP7
// I2C1 SDA - GP6
